...
function CardPostagem({ post }: CardPostagemProps) {
    return (
        <div className='flex flex-col overflow-hidden justify-between  rounded-xl shadow-md bg-light-background3 dark:bg-dark-background3'>
            ...
            <div className="flex border-t-2 dark:border-dark-background2">
                <Link to={`/editor/postagem/${post.id}`} className='text-blue-500 w-full border-r-2 dark:border-dark-background2 flex items-center justify-center py-2 no-underline hover:bg-light-background2 dark:hover:bg-dark-background2'>
